...
{
	public class SymbolsEditorPresenter : ISymbolsEditorPresenter
	{
		private ISymbolsEditorModel Model { get; }
		private ISymbolsEditorView View { get; }
		public SymbolsEditorPresenter(SymbolsEditorView view)
		{
